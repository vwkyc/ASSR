...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('#text04', { style: 'fade-in', speed: 1125, intensity: 5, threshold: 3, delay: 250, replay: false });
		onvisible.add('#text01', { style: 'fade-in', speed: 1125, intensity: 5, threshold: 3, delay: 250, replay: false });
		onvisible.add('#text02', { style: 'blur-in', speed: 625, intensity: 10, threshold: 3, delay: 1625, replay: false });
